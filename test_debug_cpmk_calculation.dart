...
void main() async {
  ...
  print('\n' + '='*80);
  print('🔍 CALCULATION WITH DEBUG OUTPUT (FORMULA BREAKDOWN)');
  print('='*80 + '\n');
  ...
  try {
    ...
    if (result['status'] == 'success') {
      ...
      final expectedSubCpmk = <String, double>{
        '276': 76.12,
        '277': 72.50,
        '278': 77.37,
        '279': 72.50,
      ...
      print('\n📋 Sub-CPMK Comparison:');
      bool allMatch = true;
      expectedSubCpmk.forEach((subId, expectedVal) {
      ...
      if (allMatch) {
        ...
        print('Debug output successfully shows formula breakdown for each Sub-CPMK and CPMK');
      } else {
